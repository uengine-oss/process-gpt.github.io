import{aA as AIGenerator,aL as getDefaultExportFromCjs,_ as _export_sfc,s as resolveComponent,o as openBlock,c as createElementBlock,x as createBlock,w as withCtx,b as createVNode,V as VBtn,F as createCommentVNode,a as createBaseVNode,am as VCardTitle,aq as VCardText,R as VAvatar,Q as VImg,a2 as VTextField,aw as VCardActions,a8 as VSpacer,al as VCard,ax as VSelect,B as VChip,z as toDisplayString,ak as VDialog,d as createTextVNode,aB as _sfc_main$3,aD as partialParse,M as renderList,$ as VDivider,L as Fragment,P as defineComponent}from"./index-dcd728bc.js";import{_ as _sfc_main$4}from"./AppBaseCard.vue_vue_type_style_index_0_lang-86309e8f.js";import{C as Chat}from"./Chat-1fd8903b.js";import"./chat-icon-7da84487.js";import"./VSheet-42154d36.js";import"./VAlert-d5b63406.js";class OrganizationChartGenerator extends AIGenerator{constructor(n,t){super(n,t),this.contexts=null;const o=JSON.stringify(n.organizaionChart),s=JSON.stringify(n.userList);this.previousMessages=[{role:"system",content:`이제부터 너는 우리 회사의 조직도 차트를 생성하거나 신규 사원 추가, 퇴사 직원 삭제, 부서 이동, 역할 변경 등 인사 관리 기능을 담당하는 인사 관리자야. 대화를 통해 알게 된 정보와 기존 조직도 차트, 직원 목록을 통해 조직도 차트를 생성하거나 신규 사원 추가, 퇴사 직원 삭제, 부서 이동, 역할 변경 등 인사 관리 기능을 수행해야 해. 추가, 삭제, 이동 같은 인사 관리 기능을 수행하고 나면 해당 결과는 무조건 조직도 차트에 반영해야 해.
            ...
            `}]}createPrompt(){return this.client.newMessage}}var ApexTree$1={exports:{}};(function(module,exports){(function(n,t){module.exports=t()})(self,()=>(()=>{var __webpack_modules__={"./node_modules/@svgdotjs/svg.js/dist/svg.esm.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{eval(`__webpack_require__.r(__webpack_exports__);
...
//# sourceURL=webpack://ApexTree/./node_modules/@svgdotjs/svg.js/dist/svg.esm.js?`)},"./node_modules/@svgdotjs/svg.panzoom.js/dist/svg.panzoom.esm.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{eval(`__webpack_require__.r(__webpack_exports__);
...
//# sourceURL=webpack://ApexTree/./node_modules/@svgdotjs/svg.panzoom.js/dist/svg.panzoom.esm.js?`)},"./src/ApexTree.ts":(__unused_webpack_module,exports,__webpack_require__)=>{eval(`
...
//# sourceURL=webpack://ApexTree/./src/ApexTree.ts?`)},"./src/models/Export.ts":(__unused_webpack_module,exports)=>{eval(`
...
//# sourceURL=webpack://ApexTree/./src/models/Export.ts?`)},"./src/models/Graph.ts":function(__unused_webpack_module,exports,__webpack_require__){eval(`
...
//# sourceURL=webpack://ApexTree/./src/models/Graph.ts?`)},"./src/models/Paper.ts":(__unused_webpack_module,exports,__webpack_require__)=>{eval(`
...
//# sourceURL=webpack://ApexTree/./src/models/Paper.ts?`)},"./src/models/Toolbar.ts":function(__unused_webpack_module,exports,__webpack_require__){eval(`
...
//# sourceURL=webpack://ApexTree/./src/models/Toolbar.ts?`)},"./src/models/index.ts":(__unused_webpack_module,exports,__webpack_require__)=>{eval(`
...
//# sourceURL=webpack://ApexTree/./src/models/index.ts?`)},"./src/settings/DirectionConfig.ts":(__unused_webpack_module,exports)=>{eval(`
...
//# sourceURL=webpack://ApexTree/./src/settings/DirectionConfig.ts?`)},"./src/settings/Options.ts":(__unused_webpack_module,exports)=>{eval(`
...
//# sourceURL=webpack://ApexTree/./src/settings/Options.ts?`)},"./src/utils/EdgeUtils.ts":(__unused_webpack_module,exports,__webpack_require__)=>{eval(`
...
//# sourceURL=webpack://ApexTree/./src/utils/EdgeUtils.ts?`)},"./src/utils/GraphUtils.ts":(__unused_webpack_module,exports)=>{eval(`
...
//# sourceURL=webpack://ApexTree/./src/utils/GraphUtils.ts?`)},"./src/utils/index.ts":function(__unused_webpack_module,exports,__webpack_require__){eval(`
...
//# sourceURL=webpack://ApexTree/./src/utils/index.ts?`)},"./node_modules/d3-flextree/index.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{eval(`__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
...
//# sourceURL=webpack://ApexTree/./node_modules/d3-flextree/index.js?`)},"./node_modules/d3-flextree/src/flextree.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{eval(`__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
...
//# sourceURL=webpack://ApexTree/./node_modules/d3-flextree/src/flextree.js?`)},"./node_modules/d3-hierarchy/src/hierarchy/ancestors.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{eval(`__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
...
//# sourceURL=webpack://ApexTree/./node_modules/d3-hierarchy/src/hierarchy/ancestors.js?`)},"./node_modules/d3-hierarchy/src/hierarchy/count.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{eval(`__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* export default binding */ __WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
function count(node) {
...
//# sourceURL=webpack://ApexTree/./node_modules/d3-hierarchy/src/hierarchy/count.js?`)},"./node_modules/d3-hierarchy/src/hierarchy/descendants.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{eval(`__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* export default binding */ __WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
...
//# sourceURL=webpack://ApexTree/./node_modules/d3-hierarchy/src/hierarchy/descendants.js?`)},"./node_modules/d3-hierarchy/src/hierarchy/each.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{eval(`__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* export default binding */ __WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
...
//# sourceURL=webpack://ApexTree/./node_modules/d3-hierarchy/src/hierarchy/each.js?`)},"./node_modules/d3-hierarchy/src/hierarchy/eachAfter.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{eval(`__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* export default binding */ __WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(callback) {
...
//# sourceURL=webpack://ApexTree/./node_modules/d3-hierarchy/src/hierarchy/eachAfter.js?`)},"./node_modules/d3-hierarchy/src/hierarchy/eachBefore.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{eval(`__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* export default binding */ __WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(callback) {
...
//# sourceURL=webpack://ApexTree/./node_modules/d3-hierarchy/src/hierarchy/eachBefore.js?`)},"./node_modules/d3-hierarchy/src/hierarchy/index.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{eval(`__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
...
//# sourceURL=webpack://ApexTree/./node_modules/d3-hierarchy/src/hierarchy/index.js?`)},"./node_modules/d3-hierarchy/src/hierarchy/leaves.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{eval(`__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* export default binding */ __WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
...
//# sourceURL=webpack://ApexTree/./node_modules/d3-hierarchy/src/hierarchy/leaves.js?`)},"./node_modules/d3-hierarchy/src/hierarchy/links.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{eval(`__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* export default binding */ __WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
...
//# sourceURL=webpack://ApexTree/./node_modules/d3-hierarchy/src/hierarchy/links.js?`)},"./node_modules/d3-hierarchy/src/hierarchy/path.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{eval(`__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* export default binding */ __WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
...
//# sourceURL=webpack://ApexTree/./node_modules/d3-hierarchy/src/hierarchy/path.js?`)},"./node_modules/d3-hierarchy/src/hierarchy/sort.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{eval(`__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* export default binding */ __WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
...
//# sourceURL=webpack://ApexTree/./node_modules/d3-hierarchy/src/hierarchy/sort.js?`)},"./node_modules/d3-hierarchy/src/hierarchy/sum.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{eval(`__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* export default binding */ __WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
...
//# sourceURL=webpack://ApexTree/./node_modules/d3-hierarchy/src/hierarchy/sum.js?`)},"./src/icons/add-circle.svg":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{eval(`__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
...
//# sourceURL=webpack://ApexTree/./src/icons/add-circle.svg?`)},"./src/icons/export-icon.svg":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{eval(`__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
...
//# sourceURL=webpack://ApexTree/./src/icons/export-icon.svg?`)},"./src/icons/fit-screen-icon.svg":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{eval(`__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
...
//# sourceURL=webpack://ApexTree/./src/icons/fit-screen-icon.svg?`)},"./src/icons/minus-circle.svg":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{eval(`__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
...
//# sourceURL=webpack://ApexTree/./src/icons/minus-circle.svg?`)},"./src/icons/zoom-in-icon.svg":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{eval(`__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
...
//# sourceURL=webpack://ApexTree/./src/icons/zoom-in-icon.svg?`)},"./src/icons/zoom-out-icon.svg":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{eval(`__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
...
//# sourceURL=webpack://ApexTree/./src/icons/zoom-out-icon.svg?`)},"./node_modules/d3-flextree/package.json":module=>{eval(`module.exports = JSON.parse('{"name":"d3-flextree","version":"2.1.2","main":"build/d3-flextree.js","module":"index","jsnext:main":"index","author":{"name":"Chris Maloney","url":"http://chrismaloney.org"},"description":"Flexible tree layout algorithm that allows for variable node sizes.","keywords":["d3","d3-module","layout","tree","hierarchy","d3-hierarchy","plugin","d3-plugin","infovis","visualization","2d"],"homepage":"https://github.com/klortho/d3-flextree","license":"WTFPL","repository":{"type":"git","url":"https://github.com/klortho/d3-flextree.git"},"scripts":{"clean":"rm -rf build demo test","build:demo":"rollup -c --environment BUILD:demo","build:dev":"rollup -c --environment BUILD:dev","build:prod":"rollup -c --environment BUILD:prod","build:test":"rollup -c --environment BUILD:test","build":"rollup -c","lint":"eslint index.js src","test:main":"node test/bundle.js","test:browser":"node test/browser-tests.js","test":"npm-run-all test:*","prepare":"npm-run-all clean build lint test"},"dependencies":{"d3-hierarchy":"^1.1.5"},"devDependencies":{"babel-plugin-external-helpers":"^6.22.0","babel-preset-es2015-rollup":"^3.0.0","d3":"^4.13.0","d3-selection-multi":"^1.0.1","eslint":"^4.19.1","jsdom":"^11.6.2","npm-run-all":"^4.1.2","rollup":"^0.55.3","rollup-plugin-babel":"^2.7.1","rollup-plugin-commonjs":"^8.0.2","rollup-plugin-copy":"^0.2.3","rollup-plugin-json":"^2.3.0","rollup-plugin-node-resolve":"^3.0.2","rollup-plugin-uglify":"^3.0.0","uglify-es":"^3.3.9"}}');

//# sourceURL=webpack://ApexTree/./node_modules/d3-flextree/package.json?`)}},__webpack_module_cache__={};function __webpack_require__(e){var n=__webpack_module_cache__[e];if(n!==void 0)return n.exports;var t=__webpack_module_cache__[e]={exports:{}};return __webpack_modules__[e].call(t.exports,t,t.exports,__webpack_require__),t.exports}__webpack_require__.d=(e,n)=>{for(var t in n)__webpack_require__.o(n,t)&&!__webpack_require__.o(e,t)&&Object.defineProperty(e,t,{enumerable:!0,get:n[t]})},__webpack_require__.o=(e,n)=>Object.prototype.hasOwnProperty.call(e,n),__webpack_require__.r=e=>{typeof Symbol<"u"&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})};var __webpack_exports__=__webpack_require__("./src/ApexTree.ts");return __webpack_exports__=__webpack_exports__.ApexTree,__webpack_exports__})())})(ApexTree$1);var ApexTreeExports=ApexTree$1.exports;const ApexTree=getDefaultExportFromCjs(ApexTreeExports),OrganizationChart_vue_vue_type_style_index_0_scoped_57b32f74_lang="",_sfc_main$2={props:{node:{type:Object,default:{}},userList:{type:Array,default:[]}},data:()=>({tree:null,openMenu:!1,editUser:null,dialog:!1,dialogType:"",allTeams:[],allUsers:[]}),computed:{isRoot(){return this.editUser.id==="root"},currentTeam(){return this.allTeams.find(e=>e.id===this.editUser.data.pid)}},watch:{node(e){e&&e.id&&e.data&&(this.drawTree(),this.allTeams=e.children.filter(n=>n.data.isTeam).map(n=>({id:n.id,name:n.data.name})))},userList(e){this.allUsers=e.map(n=>({id:n.id,name:n.username,data:{name:n.username,img:n.profile,email:n.email,role:n.role||"",pid:n.pid||""}}))}},async mounted(){if(this.node&&this.node.id&&this.node.data){const e={contentKey:"data",width:800,height:500,nodeWidth:200,nodeHeight:100,childrenSpacing:50,siblingSpacing:20,direction:"top",enableExpandCollapse:!0,nodeTemplate:n=>`
                <div class='node-content' id='${n.id}' style='display: flex; padding: 10px; flex-direction: row;justify-content: space-between; align-items: center; height: 100%;'>
                    <img style='width: 45px; height: 45px; border-radius: 50%;' src='${n.img}' />
                    <div style='margin-left: 10px'>
                        <div style="font-weight: bold; font-family: Arial; font-size: 14px;">${n.name}</div>
                        ${n.email?`<div style="font-family: Arial; font-size: 12px">${n.email}</div>`:""}
                        ${n.role?`<div style="font-family: Arial; font-size: 12px">${n.role}</div>`:""}
                    </div>
                </div>
                `,enableToolbar:!0};this.tree=new ApexTree(document.getElementById("tree"),e),await this.drawTree(),this.allTeams=this.node.children.filter(n=>n.data.isTeam).map(n=>({id:n.id,name:n.data.name}))}this.$refs.tree.addEventListener("click",this.handleNodeClick),this.$refs.tree.addEventListener("contextmenu",this.handleNodeClick)},methods:{drawTree(){this.tree.render(this.node)},findNodeById(e,n){if(e.id===n)return e;if(e.children)for(let t of e.children){let o=this.findNodeById(t,n);if(o)return o}return null},handleNodeClick(e){e.preventDefault();const n=e.target.closest(".node-content");if(n){this.previousTarget&&this.previousTarget!==n&&(this.previousTarget.style.backgroundColor="");const t=this.findNodeById(this.node,n.id);t&&t.data&&(this.editUser=t,this.openMenu||(this.openMenu=!0)),n.style.backgroundColor="#d7d7d7",this.previousTarget=n}else this.previousTarget&&(this.previousTarget.style.backgroundColor=""),this.openMenu=!1},openDialog(e){this.dialog=!0,this.dialogType=e}}},_hoisted_1$1={key:0,style:{position:"fixed",right:"40px","z-index":"1000","margin-top":"60px"}},_hoisted_2$1=createTextVNode(" 팀 추가 "),_hoisted_3$1={key:1,class:"d-flex"},_hoisted_4$1=createTextVNode(" 팀원 추가 "),_hoisted_5$1=createTextVNode(" 수정 "),_hoisted_6$1=createTextVNode(" 삭제 "),_hoisted_7={id:"tree",ref:"tree",class:"h-100"},_hoisted_8=createTextVNode("팀 추가"),_hoisted_9=createTextVNode("추가"),_hoisted_10=createTextVNode("취소"),_hoisted_11=createTextVNode("팀원 추가"),_hoisted_12={key:1,class:"text-grey text-caption align-self-center"},_hoisted_13=createTextVNode("추가"),_hoisted_14=createTextVNode("취소"),_hoisted_15=createTextVNode("수정"),_hoisted_16=createTextVNode("취소"),_hoisted_17={key:0},_hoisted_18={key:1},_hoisted_19=createTextVNode("삭제"),_hoisted_20=createTextVNode("취소");function _sfc_render$1(e,n,t,o,s,a){const l=resolveComponent("Icon");return openBlock(),createElementBlock("div",null,[e.openMenu?(openBlock(),createElementBlock("div",_hoisted_1$1,[a.isRoot?(openBlock(),createBlock(VBtn,{key:0,color:"primary",class:"ml-2",variant:"flat",density:"comfortable",onClick:n[0]||(n[0]=r=>a.openDialog("addTeam"))},{prepend:withCtx(()=>[createVNode(l,{icon:"tabler:users-plus",width:"20",height:"20"})]),default:withCtx(()=>[_hoisted_2$1]),_:1})):(openBlock(),createElementBlock("div",_hoisted_3$1,[e.editUser.data.isTeam?(openBlock(),createBlock(VBtn,{key:0,color:"primary",variant:"flat",density:"comfortable",onClick:n[1]||(n[1]=r=>a.openDialog("addUser"))},{prepend:withCtx(()=>[createVNode(l,{icon:"tabler:user-plus",width:"20",height:"20"})]),default:withCtx(()=>[_hoisted_4$1]),_:1})):createCommentVNode("",!0),createVNode(VBtn,{color:"info",class:"ml-2",variant:"flat",density:"comfortable",onClick:n[2]||(n[2]=r=>a.openDialog("edit"))},{prepend:withCtx(()=>[createVNode(l,{icon:"tabler:user-edit",width:"20",height:"20"})]),default:withCtx(()=>[_hoisted_5$1]),_:1}),createVNode(VBtn,{color:"error",class:"ml-2",variant:"flat",density:"comfortable",onClick:n[3]||(n[3]=r=>a.openDialog("delete"))},{prepend:withCtx(()=>[createVNode(l,{icon:"tabler:user-minus",width:"20",height:"20"})]),default:withCtx(()=>[_hoisted_6$1]),_:1})]))])):createCommentVNode("",!0),createBaseVNode("div",_hoisted_7,null,512),createVNode(VDialog,{modelValue:e.dialog,"onUpdate:modelValue":n[16]||(n[16]=r=>e.dialog=r),"max-width":"500"},{default:withCtx(()=>[e.dialogType=="addTeam"?(openBlock(),createBlock(VCard,{key:0},{default:withCtx(()=>[createVNode(VCardTitle,null,{default:withCtx(()=>[_hoisted_8]),_:1}),createVNode(VCardText,{class:"text-center"},{default:withCtx(()=>[createVNode(VAvatar,{color:"grey",rounded:"0",size:"100",class:"mb-5"},{default:withCtx(()=>[createVNode(VImg,{src:""})]),_:1}),createVNode(VTextField,{label:"팀 ID"}),createVNode(VTextField,{label:"팀명"})]),_:1}),createVNode(VCardActions,{class:"pt-0"},{default:withCtx(()=>[createVNode(VSpacer),createVNode(VBtn,{color:"primary",onClick:n[4]||(n[4]=r=>e.dialog=!1)},{default:withCtx(()=>[_hoisted_9]),_:1}),createVNode(VBtn,{color:"error",onClick:n[5]||(n[5]=r=>e.dialog=!1)},{default:withCtx(()=>[_hoisted_10]),_:1})]),_:1})]),_:1})):createCommentVNode("",!0),e.dialogType=="addUser"?(openBlock(),createBlock(VCard,{key:1},{default:withCtx(()=>[createVNode(VCardTitle,null,{default:withCtx(()=>[_hoisted_11]),_:1}),createVNode(VCardText,{class:"text-center"},{default:withCtx(()=>[createVNode(VSelect,{modelValue:e.editUser.children,"onUpdate:modelValue":n[6]||(n[6]=r=>e.editUser.children=r),items:e.allUsers,label:"팀원",multiple:"","item-title":"data.name"},{selection:withCtx(({item:r,index:h})=>[h<4?(openBlock(),createBlock(VChip,{key:0},{default:withCtx(()=>[createBaseVNode("span",null,toDisplayString(r.raw.data.name),1)]),_:2},1024)):createCommentVNode("",!0),h===4?(openBlock(),createElementBlock("span",_hoisted_12," (+"+toDisplayString(e.editUser.children.length-4)+" others) ",1)):createCommentVNode("",!0)]),_:1},8,["modelValue","items"])]),_:1}),createVNode(VCardActions,{class:"pt-0"},{default:withCtx(()=>[createVNode(VSpacer),createVNode(VBtn,{color:"primary",onClick:n[7]||(n[7]=r=>e.dialog=!1)},{default:withCtx(()=>[_hoisted_13]),_:1}),createVNode(VBtn,{color:"error",onClick:n[8]||(n[8]=r=>e.dialog=!1)},{default:withCtx(()=>[_hoisted_14]),_:1})]),_:1})]),_:1})):createCommentVNode("",!0),e.dialogType=="edit"?(openBlock(),createBlock(VCard,{key:2},{default:withCtx(()=>[createVNode(VCardText,{class:"text-center"},{default:withCtx(()=>[createVNode(VAvatar,{color:"grey",rounded:"0",size:"100",class:"mb-5"},{default:withCtx(()=>[e.editUser.data.img?(openBlock(),createBlock(VImg,{key:0,src:e.editUser.data.img},null,8,["src"])):createCommentVNode("",!0)]),_:1}),e.editUser.data.isTeam?createCommentVNode("",!0):(openBlock(),createBlock(VSelect,{key:0,modelValue:e.editUser.data.pid,"onUpdate:modelValue":n[9]||(n[9]=r=>e.editUser.data.pid=r),items:e.allTeams,"item-title":"name","item-value":"id",label:"팀"},null,8,["modelValue","items"])),createVNode(VTextField,{modelValue:e.editUser.data.name,"onUpdate:modelValue":n[10]||(n[10]=r=>e.editUser.data.name=r),label:"이름"},null,8,["modelValue"]),e.editUser.data.role?(openBlock(),createBlock(VTextField,{key:1,modelValue:e.editUser.data.role,"onUpdate:modelValue":n[11]||(n[11]=r=>e.editUser.data.role=r),label:"역할"},null,8,["modelValue"])):createCommentVNode("",!0)]),_:1}),createVNode(VCardActions,{class:"pt-0"},{default:withCtx(()=>[createVNode(VSpacer),createVNode(VBtn,{color:"primary",onClick:n[12]||(n[12]=r=>e.dialog=!1)},{default:withCtx(()=>[_hoisted_15]),_:1}),createVNode(VBtn,{color:"error",onClick:n[13]||(n[13]=r=>e.dialog=!1)},{default:withCtx(()=>[_hoisted_16]),_:1})]),_:1})]),_:1})):createCommentVNode("",!0),e.dialogType=="delete"?(openBlock(),createBlock(VCard,{key:3},{default:withCtx(()=>[createVNode(VCardText,null,{default:withCtx(()=>[e.editUser.data.isTeam?(openBlock(),createElementBlock("div",_hoisted_17,"'"+toDisplayString(e.editUser.data.name)+"' 을/를 삭제하시겠습니까?",1)):(openBlock(),createElementBlock("div",_hoisted_18,"'"+toDisplayString(a.currentTeam.name)+"' 에서 '"+toDisplayString(e.editUser.data.name)+"' 님을 삭제하시겠습니까?",1))]),_:1}),createVNode(VCardActions,null,{default:withCtx(()=>[createVNode(VSpacer),createVNode(VBtn,{color:"primary",onClick:n[14]||(n[14]=r=>e.dialog=!1)},{default:withCtx(()=>[_hoisted_19]),_:1}),createVNode(VBtn,{color:"error",onClick:n[15]||(n[15]=r=>e.dialog=!1)},{default:withCtx(()=>[_hoisted_20]),_:1})]),_:1})]),_:1})):createCommentVNode("",!0)]),_:1},8,["modelValue"])])}const OrganizationChart=_export_sfc(_sfc_main$2,[["render",_sfc_render$1],["__scopeId","data-v-57b32f74"]]),storageKey="configuration",_sfc_main$1={mixins:[_sfc_main$3],components:{AppBaseCard:_sfc_main$4,Chat,OrganizationChart},data:()=>({organizationChart:[],userList:[],chatInfo:{title:"organizationChartDefinition.cardTitle",text:"organizationChartDefinition.organizationChartExplanation"},userDialog:!1,newUserList:[]}),async created(){await this.init(),this.generator=new OrganizationChartGenerator(this,{isStream:!0,preferredLanguage:"Korean"})},methods:{async loadData(e){const n=await this.getData(`${storageKey}/organization`,{key:"key"});n&&n.value&&n.value.chart&&(this.organizationChart=n.value.chart,this.organizationChart||(this.organizationChart=[]));const t=await this.getData(`${storageKey}/organization_chat`,{key:"key"});t&&t.value&&t.value.message&&(this.messages=t.value.message),this.userList=await this.storage.list("users")},beforeSendMessage(e){this.sendMessage(e)},afterModelCreated(e){let n=this.messages[this.messages.length-1];if(n.jsonContent){let t;try{t=partialParse(n.jsonContent)}catch(o){console.log(o),t=JSON.parse(n.jsonContent)}t&&!t.modifications&&t.organizationChart&&this.drawChart(t)}},drawChart(e){e&&e.organizationChart&&(this.organizationChart=e.organizationChart)},async afterGenerationFinished(e){let n=this.messages[this.messages.length-1];if(n.jsonContent){let o;try{o=partialParse(n.jsonContent)}catch(s){console.log(s);return}if(o&&o.modifications&&(console.log(o.modifications),o.modifications.forEach(s=>{s.action=="replace"?this.jsonPathReplace(this,s.targetJsonPath,s.value):s.action=="add"?this.jsonPathAdd(this,s.targetJsonPath,s.value):s.action=="delete"&&this.jsonPathDelete(this,s.targetJsonPath)})),o&&o.newUsers)this.newUserList=o.newUsers,this.userDialog=!0;else if(o&&o.deleteUsers)this.deleteUser(o.deleteUsers);else{const s={key:"organization",value:{chart:this.organizationChart}};this.drawChart(this.organizationChart),this.putObject(storageKey,s)}}const t={key:"organization_chat",value:{message:this.messages}};this.putObject(storageKey,t)},afterModelStopped(e){const n={key:"organization_chat",value:{message:this.messages}};this.putObject(storageKey,n)},async createNewUser(e){e&&e.length>0&&(e.forEach(async n=>{let t={username:n.name,email:n.email,password:"000000"};const o=await this.storage.createUser(t);o.user&&(t={id:o.user.id,username:n.name,email:n.email},await this.putObject("users",t))}),this.userList=await this.storage.list("users")),this.newUserList=[],this.userDialog=!1},async deleteUser(e){e&&e.length>0&&(e.forEach(async n=>{const t={match:{email:n.email,username:n.name}};await this.storage.delete("users",t)}),this.userList=await this.storage.list("users"))}}},_hoisted_1=createTextVNode("신규 입사자 가입"),_hoisted_2=createTextVNode("가입"),_hoisted_3=createTextVNode("닫기"),_hoisted_4=createTextVNode("신규 입사자 가입"),_hoisted_5=createTextVNode("가입"),_hoisted_6=createTextVNode("닫기");function _sfc_render(e,n,t,o,s,a){const l=resolveComponent("Chat"),r=resolveComponent("OrganizationChart"),h=resolveComponent("AppBaseCard");return openBlock(),createBlock(h,null,{leftpart:withCtx(()=>[createVNode(l,{messages:e.messages,chatInfo:e.chatInfo,userInfo:e.userInfo,disableChat:e.disableChat,onSendMessage:a.beforeSendMessage,onSendEditedMessage:e.sendEditedMessage,onStopMessage:e.stopMessage},null,8,["messages","chatInfo","userInfo","disableChat","onSendMessage","onSendEditedMessage","onStopMessage"]),createVNode(VDialog,{modelValue:e.userDialog,"onUpdate:modelValue":n[2]||(n[2]=i=>e.userDialog=i),"max-width":"500"},{default:withCtx(()=>[createVNode(VCard,null,{default:withCtx(()=>[createVNode(VCardTitle,null,{default:withCtx(()=>[_hoisted_1]),_:1}),createVNode(VCardText,{class:"overflow-y-auto"},{default:withCtx(()=>[(openBlock(!0),createElementBlock(Fragment,null,renderList(e.newUserList,(i,c)=>(openBlock(),createElementBlock("div",{key:c,class:"py-2"},[createVNode(VTextField,{modelValue:i.name,"onUpdate:modelValue":d=>i.name=d,label:"이름"},null,8,["modelValue","onUpdate:modelValue"]),createVNode(VTextField,{modelValue:i.email,"onUpdate:modelValue":d=>i.email=d,label:"이메일"},null,8,["modelValue","onUpdate:modelValue"]),createVNode(VDivider)]))),128))]),_:1}),createVNode(VCardActions,null,{default:withCtx(()=>[createVNode(VSpacer),createVNode(VBtn,{color:"primary",onClick:n[0]||(n[0]=i=>a.createNewUser(e.newUserList))},{default:withCtx(()=>[_hoisted_2]),_:1}),createVNode(VBtn,{color:"error",onClick:n[1]||(n[1]=i=>e.userDialog=!1)},{default:withCtx(()=>[_hoisted_3]),_:1})]),_:1})]),_:1})]),_:1},8,["modelValue"])]),rightpart:withCtx(()=>[(openBlock(),createBlock(r,{node:e.organizationChart,key:e.organizationChart.id,userList:e.userList},null,8,["node","userList"]))]),mobileLeftContent:withCtx(()=>[createVNode(l,{messages:e.messages,chatInfo:e.chatInfo,userInfo:e.userInfo,disableChat:e.disableChat,onSendMessage:a.beforeSendMessage,onSendEditedMessage:e.sendEditedMessage,onStopMessage:e.stopMessage},null,8,["messages","chatInfo","userInfo","disableChat","onSendMessage","onSendEditedMessage","onStopMessage"]),createVNode(VDialog,{modelValue:e.userDialog,"onUpdate:modelValue":n[5]||(n[5]=i=>e.userDialog=i),"max-width":"500"},{default:withCtx(()=>[createVNode(VCard,null,{default:withCtx(()=>[createVNode(VCardTitle,null,{default:withCtx(()=>[_hoisted_4]),_:1}),createVNode(VCardText,null,{default:withCtx(()=>[(openBlock(!0),createElementBlock(Fragment,null,renderList(e.newUserList,(i,c)=>(openBlock(),createElementBlock("div",{key:c,class:"py-2"},[createVNode(VTextField,{modelValue:i.name,"onUpdate:modelValue":d=>i.name=d,label:"이름"},null,8,["modelValue","onUpdate:modelValue"]),createVNode(VTextField,{modelValue:i.email,"onUpdate:modelValue":d=>i.email=d,label:"이메일"},null,8,["modelValue","onUpdate:modelValue"]),createVNode(VDivider)]))),128))]),_:1}),createVNode(VCardActions,null,{default:withCtx(()=>[createVNode(VSpacer),createVNode(VBtn,{color:"primary",onClick:n[3]||(n[3]=i=>a.createNewUser(e.newUserList))},{default:withCtx(()=>[_hoisted_5]),_:1}),createVNode(VBtn,{color:"error",onClick:n[4]||(n[4]=i=>e.userDialog=!1)},{default:withCtx(()=>[_hoisted_6]),_:1})]),_:1})]),_:1})]),_:1},8,["modelValue"])]),_:1})}const OrganizationChartChat=_export_sfc(_sfc_main$1,[["render",_sfc_render]]),_sfc_main=defineComponent({setup(e){return(n,t)=>(openBlock(),createBlock(VCard,{elevation:"10"},{default:withCtx(()=>[createVNode(OrganizationChartChat)]),_:1}))}});export{_sfc_main as default};
